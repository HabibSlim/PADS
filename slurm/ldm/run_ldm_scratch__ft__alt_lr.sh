...
#SBATCH -J ldm_scratch__ft__alt_lr
#SBATCH -o slurm/log/ldm_scratch__ft__alt_lr.log
#SBATCH --partition=batchhttps://opensource.fb.com/support-ukraine
#SBATCH --nodes=1
#SBATCH --mem=128G
...
torchrun \
    ...
    --output_dir output/graph_edit/dm/ldm_scratch__ft__alt_lr \
    --log_dir output/graph_edit/dm/ldm_scratch__ft__alt_lr \
    --resume output/graph_edit/dm/ldm_scratch__ft__alt_lr/checkpoint-99.pth \
    --resume_full_weights \
    --num_workers 8 \
    ...
    --data_type release \
    --exp_name ldm_scratch__ft__alt_lr \
    --dist_eval \
    --use_embeds \
    --n_replicas 1 \
    --clip_grad 3.0 \
