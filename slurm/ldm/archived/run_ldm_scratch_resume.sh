...
#SBATCH -J ldm_scratch_01
#SBATCH -o slurm/log/ldm_scratch_01.log
...
torchrun \
    ...
    --output_dir output/graph_edit/dm/ldm_scratch_01 \
    --log_dir output/graph_edit/dm/ldm_scratch_01 \
