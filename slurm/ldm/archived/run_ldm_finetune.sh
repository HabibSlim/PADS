...
#SBATCH -J ldm_finetune_01
#SBATCH -o slurm/log/ldm_finetune_01.log
...
torchrun \
    ...
    --output_dir output/graph_edit/dm/ldm_finetune_01 \
    --log_dir output/graph_edit/dm/ldm_finetune_01 \
    --num_workers 8 \
    --batch_size 16 \
