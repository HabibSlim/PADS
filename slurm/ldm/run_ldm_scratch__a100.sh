...
#SBATCH -J ldm_scratch_a100_for_real_01
#SBATCH -o slurm/log/ldm_scratch_a100_for_real_01.log
...
torchrun \
    ...
    --output_dir output/graph_edit/dm/ldm_scratch_a100_for_real_01 \
    --log_dir output/graph_edit/dm/ldm_scratch_a100_for_real_01 \
    --num_workers 8 \
    ...
    --data_type release \
    --exp_name ldm_scratch_a100_for_real_01 \
    --dist_eval \
    --use_embeds \
    --lr 1e-4 \
    --clip_grad 3.0
