...
#SBATCH -J mlp_mapper_bert_l4_pcae
#SBATCH -o slurm/log/mlp_mapper_bert_l4_pcae.log
...
torchrun \
    ...
    --accum_iter 1 \
    --model mlp_mapper_bert_l4_pcae \
    --ae kl_d512_m512_l8 \
    --ae_pth output/graph_edit/ae/ae_m512.pth \
    --output_dir output/graph_edit/dm/mlp_mapper_bert_l4_pcae \
    --log_dir output/graph_edit/dm/mlp_mapper_bert_l4_pcae \
    --num_workers 8 \
    --batch_size 32 \
    ...
    --data_type release \
    --exp_name mlp_mapper_bert_l4_pcae \
    --dist_eval \
    --use_embeds \
    --alt_ae_embeds pc_ae \
    --lr 1e-4 \
