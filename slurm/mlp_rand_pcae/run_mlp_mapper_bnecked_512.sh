...
#SBATCH -J mlp_mapper_bert_bneck_512_pcae
#SBATCH -o slurm/log/mlp_mapper_bert_bneck_512_pcae.log
...
torchrun \
    ...
    --output_dir output/graph_edit/dm/mlp_mapper_bert_bneck_512_pcae \
    --log_dir output/graph_edit/dm/mlp_mapper_bert_bneck_512_pcae \
    --num_workers 4 \
    --batch_size 32 \
    ...
    --data_type release \
    --exp_name mlp_mapper_bert_bneck_512_pcae \
    --dist_eval \
    --use_embeds \
    --alt_ae_embeds pc_ae \
    --lr 1e-4 \
